...
const getAllProducts = async () => {
  try {
    const response = await axios.get(`https://cobalt-blue-jellyfish-boot.cyclic.app/interiorimage`);
...
const divStyle = {
  ...
  <div style={{ "textTransform": "uppercase" }} className='text-3xl text-center md:text-3xl font-bold mt-6'>Some Glimpse of our Modular Kitchens </div>
