...
const getAllProducts = async () => {
  try {
    const response = await axios.get(`https://cobalt-blue-jellyfish-boot.cyclic.app/shopsimage`);
...
const handleClickOpen = () => {
  ...
  <div style={{ "textTransform": "uppercase" }} className='text-3xl text-center md:text-3xl font-bold '>Retailed Shops Projects </div>
